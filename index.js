...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@_miqbal.22`)
})
...
conn.sendMessage(id, 'Ya?, butuh bantuan lu? Salam yg bener napa jingan ! (Ketik .menu)' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Kok lu gk salam sii anjink? Tenang aja disini ada bot ketik .menu untuk [menu]' ,MessageType.text);
}
else if (text == 'Halo'){
conn.sendMessage(id, 'Ehh ada bang jago, Ketik .menu untuk bantuan ya bang jago !' ,MessageType.text);
}
else if (text == 'Asu'){
...
conn.sendMessage(id, 'Lu bacot? apa capek? (.menu) aja anjing' ,MessageType.text);
}
else if (text == 'Test'){
conn.sendMessage(id, 'Test 1,2,3 gw bukan mic anjing lu ketik .menu ajjh maka nya' ,MessageType.text);
}
else if (text == 'Hai'){
conn.sendMessage(id, 'Ya Hai juga?, Ketik .menu/.info/.donasi Contoh .menu' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Nape?, gw punya nama asw, mending Ketik .menu/.info/.donasi Contoh .menu' ,MessageType.text);
}
else if (text == 'Eoy'){
conn.sendMessage(id, 'Ya?, Ketik $help/.info/.donasi Contoh .menu' ,MessageType.text);
}
else if (text == 'Hi'){
conn.sendMessage(id, 'Ya Hi juga?, Ketik .menu/.info/.donasi Contoh .menu' ,MessageType.text);
}
else if (text == 'Gan'){
conn.sendMessage(id, 'Ya knp?, Ketik .menu/.info/.donasi Contoh .menu' ,MessageType.text);
}
else if (text == 'Sis'){
conn.sendMessage(id, 'Ya knp?, Ketik .menu/.info/.donasi Contoh .menu' ,MessageType.text);
}
